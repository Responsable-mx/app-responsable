          ...
          >
            <div className="px-4 py-3 border-b border-slate-100 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                {section.description && (
                  <p className="text-xs text-slate-600 truncate mt-0.5">{section.description}</p>
                )}
              </div>
              {isComplete && (
            ...
            <div className="px-4 py-3">
              ...
              {section.fields.length > 4 && (
                <p className="text-[10px] text-slate-400 mt-2 italic">
                  +{section.fields.length - 4} campos más
                </p>
              )}
            </div>
            ...
            <div className="px-4 py-2 border-t border-slate-100 flex items-center justify-between gap-3">
              ...
              <div className="flex-1 h-1 bg-slate-100 rounded-sm overflow-hidden mx-2">
                <div
                  className={`h-full transition-all ${isComplete ? "bg-emerald-500" : sectionProgress.pct > 0 ? "bg-brand-primary" : "bg-slate-300"}`}
