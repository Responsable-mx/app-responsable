      ...
      <section className="bg-white border border-slate-200 rounded p-6">
        ...
        <div className="mt-4 bg-slate-50 border border-slate-200 rounded-lg p-4 flex items-start justify-between gap-4">
          ...
          <button
            ...
            disabled={busy}
            className="px-4 py-2 bg-brand-primary-hover text-white text-sm font-medium rounded-lg hover:bg-brand-primary-dark disabled:bg-slate-300 whitespace-nowrap"
          >
