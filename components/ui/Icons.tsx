 ...
 * Todos aceptan className para tamaño/color; viewBox y strokes consistentes.
 */
type Props = { className?: string; strokeWidth?: number };

const base = (className?: string, strokeWidth = 1.75) => ({
...
export function IconBookOpen(p: Props) {
  return (
    <svg {...base(p.className, p.strokeWidth)}>
...
export function IconClipboard(p: Props) {
  return (
...
export function IconPlugin(p: Props) {
  return (
    <svg {...base(p.className, p.strokeWidth)}>
...
// Ícono para IROs ESRS (cuadrícula de doble entrada — materialidad × dimensión)
