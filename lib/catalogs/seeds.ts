...
// Mantenido en sincronía con 0005_catalogs.sql y 0013_catalogs_alphabetical.sql.
// Convención: ítems en orden alfabético (es-MX), por grupo cuando aplica.
// Excepciones: maturity_levels (escala lógica), countries (México primero).
export const CATALOG_SEEDS: CatalogSeedItem[] = [
  // business_segments — alfabético flat
  { category: "business_segments", value: "b2b",       label: "B2B",            sort_order: 10 },
  { category: "business_segments", value: "b2b2c",     label: "B2B2C",          sort_order: 20 },
  { category: "business_segments", value: "b2c",       label: "B2C",            sort_order: 30 },
  { category: "business_segments", value: "b2g",       label: "B2G (gobierno)", sort_order: 40 },
  { category: "business_segments", value: "d2c",       label: "D2C",            sort_order: 50 },
  ...
  { category: "applicable_regulations", value: "lfpiorpi_mx",             label: "LFPIORPI (MX)",               group_name: "México", sort_order: 70 },
  { category: "applicable_regulations", value: "nis_mx",                  label: "NIS (México)",                group_name: "México", sort_order: 80 },
  { category: "applicable_regulations", value: "nom_035_mx",              label: "NOM-035 (MX)",                group_name: "México", sort_order: 90 },

  // policies — alfabético flat
  { category: "policies", value: "ambiental",       label: "Ambiental",              sort_order: 10 },
  { category: "policies", value: "anticorrupcion",  label: "Anticorrupción",         sort_order: 20 },
  { category: "policies", value: "codigo_conducta", label: "Código de conducta",     sort_order: 30 },
  { category: "policies", value: "ddhh",            label: "Derechos humanos",       sort_order: 40 },
  { category: "policies", value: "diversidad",      label: "Diversidad e inclusión", sort_order: 50 },
  { category: "policies", value: "etica",           label: "Ética",                  sort_order: 60 },
  { category: "policies", value: "proveedores",     label: "Proveedores",            sort_order: 70 },
  { category: "policies", value: "salud_seguridad", label: "Salud y seguridad",      sort_order: 80 },
  { category: "policies", value: "sostenibilidad",  label: "Sostenibilidad",         sort_order: 90 },

  // certifications — grupos alfabéticos (Ambiental, Integral, Laboral, Social)
  { category: "certifications", value: "fsc",        label: "FSC",                 group_name: "Ambiental", sort_order: 10 },
  { category: "certifications", value: "iso_14001",  label: "ISO 14001",           group_name: "Ambiental", sort_order: 20 },
  { category: "certifications", value: "leed",       label: "LEED",                group_name: "Ambiental", sort_order: 30 },
  ...
  { category: "certifications", value: "gptw",       label: "Great Place to Work", group_name: "Laboral",   sort_order: 60 },
  { category: "certifications", value: "iso_45001",  label: "ISO 45001",           group_name: "Laboral",   sort_order: 70 },
  { category: "certifications", value: "esr_cemefi", label: "ESR CEMEFI",          group_name: "Social",    sort_order: 80 },
  { category: "certifications", value: "fair_trade", label: "Fair Trade",          group_name: "Social",    sort_order: 90 },
  { category: "certifications", value: "iso_26000",  label: "ISO 26000",           group_name: "Social",    sort_order: 100 },

  // material_topics — grupos alfabéticos (Ambiental, Gobernanza, Social)
  { category: "material_topics", value: "agua",              label: "Agua",                   group_name: "Ambiental",  sort_order: 10 },
  { category: "material_topics", value: "biodiversidad",     label: "Biodiversidad",          group_name: "Ambiental",  sort_order: 20 },
  { category: "material_topics", value: "cambio_climatico",  label: "Cambio climático",       group_name: "Ambiental",  sort_order: 30 },
  { category: "material_topics", value: "economia_circular", label: "Economía circular",      group_name: "Ambiental",  sort_order: 40 },
  { category: "material_topics", value: "residuos",          label: "Residuos",               group_name: "Ambiental",  sort_order: 50 },
  { category: "material_topics", value: "etica",             label: "Ética y anticorrupción", group_name: "Gobernanza", sort_order: 60 },
  { category: "material_topics", value: "impuestos",         label: "Fiscalidad responsable", group_name: "Gobernanza", sort_order: 70 },
  { category: "material_topics", value: "privacidad",        label: "Privacidad de datos",    group_name: "Gobernanza", sort_order: 80 },
  { category: "material_topics", value: "cadena_suministro", label: "Cadena de suministro",   group_name: "Social",     sort_order: 90 },
  { category: "material_topics", value: "ddhh",              label: "Derechos humanos",       group_name: "Social",     sort_order: 100 },
  { category: "material_topics", value: "diversidad",        label: "Diversidad e inclusión", group_name: "Social",     sort_order: 110 },
  { category: "material_topics", value: "salud_seguridad",   label: "Salud y seguridad",      group_name: "Social",     sort_order: 120 },

  // maturity_levels — escala lógica (NO alfabético, intencionalmente)
  ...
  // sectors — grupos alfabéticos (Consumo, Financiero, Industrial, Primario, Salud, Servicios, TMT)
  { category: "sectors", value: "alimentos",       label: "Alimentos",               group_name: "Consumo",    sort_order: 10 },
  { category: "sectors", value: "bebidas",         label: "Bebidas",                 group_name: "Consumo",    sort_order: 20 },
  { category: "sectors", value: "consumo_masivo",  label: "Consumo masivo",          group_name: "Consumo",    sort_order: 30 },
  { category: "sectors", value: "retail",          label: "Retail",                  group_name: "Consumo",    sort_order: 40 },
  { category: "sectors", value: "banca",           label: "Banca",                   group_name: "Financiero", sort_order: 50 },
  { category: "sectors", value: "fintech",         label: "Fintech",                 group_name: "Financiero", sort_order: 60 },
  { category: "sectors", value: "seguros",         label: "Seguros",                 group_name: "Financiero", sort_order: 70 },
  { category: "sectors", value: "construccion",    label: "Construcción",            group_name: "Industrial", sort_order: 80 },
  { category: "sectors", value: "energia",         label: "Energía",                 group_name: "Industrial", sort_order: 90 },
  { category: "sectors", value: "manufactura",     label: "Manufactura",             group_name: "Industrial", sort_order: 100 },
  { category: "sectors", value: "mineria",         label: "Minería",                 group_name: "Industrial", sort_order: 110 },
  { category: "sectors", value: "transporte",      label: "Transporte y logística",  group_name: "Industrial", sort_order: 120 },
  { category: "sectors", value: "agropecuario",    label: "Agropecuario",            group_name: "Primario",   sort_order: 130 },
  { category: "sectors", value: "farmaceutico",    label: "Farmacéutico",            group_name: "Salud",      sort_order: 140 },
  { category: "sectors", value: "servicios_salud", label: "Servicios de salud",      group_name: "Salud",      sort_order: 150 },
  { category: "sectors", value: "consultoria",     label: "Consultoría profesional", group_name: "Servicios",  sort_order: 160 },
  { category: "sectors", value: "educacion",       label: "Educación",               group_name: "Servicios",  sort_order: 170 },
  { category: "sectors", value: "hospitalidad",    label: "Hospitalidad y turismo",  group_name: "Servicios",  sort_order: 180 },
  { category: "sectors", value: "inmobiliario",    label: "Inmobiliario",            group_name: "Servicios",  sort_order: 190 },
  { category: "sectors", value: "medios",          label: "Medios",                  group_name: "TMT",        sort_order: 200 },
  { category: "sectors", value: "tecnologia",      label: "Tecnología / Software",   group_name: "TMT",        sort_order: 210 },
  { category: "sectors", value: "telecom",         label: "Telecomunicaciones",      group_name: "TMT",        sort_order: 220 },
  ...
  // revenue_models — alfabético flat
  { category: "revenue_models", value: "contratos",          label: "Contratos recurrentes",   sort_order: 10 },
  { category: "revenue_models", value: "franquicia",         label: "Franquicia",              sort_order: 20 },
  { category: "revenue_models", value: "licenciamiento",     label: "Licenciamiento",          sort_order: 30 },
  { category: "revenue_models", value: "marketplace",        label: "Marketplace / comisión",  sort_order: 40 },
  { category: "revenue_models", value: "publicidad",         label: "Publicidad",              sort_order: 50 },
  { category: "revenue_models", value: "servicios_hora",     label: "Servicios por hora",      sort_order: 60 },
  { category: "revenue_models", value: "servicios_proyecto", label: "Servicios por proyecto",  sort_order: 70 },
